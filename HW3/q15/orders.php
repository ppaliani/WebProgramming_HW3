...
<body>
    ...
    <div id="large-container">
        ...
        <?php
            error_reporting(0);
            $db = mysqli_connect("127.0.0.1","root","root","db3");

            $getPwdQuery = "SELECT * FROM password";
            $pwdResults = mysqli_query($db,$getPwdQuery);
            $masterPWD = mysqli_fetch_assoc($pwdResults)['pwd'];
            ...
            if ($pwd == $masterPWD) {
                ...
                print "<p>Inorrect password entered. Please try again:</p> <a href='http://localhost:8000/q15/store.html'>Return</a>";
            }
        ?>
        </div>
        <br>
